...
<html>
    ...
    <body>
        <h1 style="text-align:center;">Liste des utilisateurs <span><a href="accueilAdmin.php">Return</a></span></h1>
            ...
            ?>
             ...
             <tr>
                 ...
                 <td><form action="detail.php" method="POST">
                     <input type="hidden" name="id" value="<?php echo $res['iduser']; ?>"/>
                     <input type="submit" value="Details"/>
                 </form>
                 <form action="supprimer.php" method="POST">
                     <input type="hidden" name="iduser" value="<?php echo $res['iduser']; ?>"/>
                     <input type="submit"  value="Supprimer" placeholder="Cette Opération est irréversible" />
                 </form>
