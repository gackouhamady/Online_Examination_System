...
if(isset($_POST['send'])){
    if(isset($_POST['password']) && isset($_POST['password_verif'])){
        ...
        if($password!=$password_verif){
           ...
           try {
            $req=$bdd->prepare("UPDATE teacher SET password=$password WHERE idteacher=$idteacher");
            $req->execute();
...
<body>
    ...
    <div style="text-align:left; margin-left:50px; font-size:1.5em;"><span>Return To</span><a style="margin-left:5px;"href="accueil.php">Accueil</a></div>
</body>
</html>
